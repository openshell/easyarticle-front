        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-3xl mx-auto">
              easyarticle 诞生于对高效内容创作的渴望。我们致力于为内容创作者提供最优质的 Markdown 编辑体验，
              让创作变得更加简单、高效和愉悦。
            </p>
          </div>
        </div>
              ...
              <div>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  <Button variant="outline" asChild>
                    <Link href="https://github.com/tianyaxiang/easyarticle" target="_blank">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-muted-foreground mb-12">
              我们使用现代化的技术栈构建 easyarticle，确保产品的性能、稳定性和可维护性
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <div className="flex justify-center gap-6 mb-8">
              <Link 
                href="https://github.com/tianyaxiang/easyarticle" 
                target="_blank"
            ...
            <Card className="border-0 shadow-md bg-primary/5">
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground">
                  easyarticle 是一个开源项目，我们欢迎任何形式的贡献，包括代码、文档、设计建议等。
                  让我们一起打造更好的内容创作工具！
                </p>
              </CardContent>
            </Card>
